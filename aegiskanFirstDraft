...
function parseCharForm() {
	var inputStr = document.getElementById("charform").value;
	// body... 
	var unicodePoint = inputStr.codePointAt(0);
	// Returns a decimal-represented code point
	console.log(unicodePoint);
	loadChar(unicodePoint);
}
